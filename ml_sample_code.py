...
def train_and_optimize(data_x, data_y):
    ...
    for i, (train, test) in enumerate(kfold1.split(data_x, data_y)):
        ...
        print('###')
        print('Best Params: {}'.format(gridcv.best_params_))
        print('Train Score: {}'.format(s_train))
        print('Cross Score: {}'.format(gridcv.best_score_))
        print('Test Score: {}'.format(s_test))
        print('###')
    ...
    print('###')
    print('CV Train Score: {} ({})'.format(train_mean, train_std))
    print('CV Cross Score: {} ({})'.format(cross_mean, cross_std))
    print('CV Test Score: {} ({})'.format(test_mean, test_std))
    print('###')
    ...
    print('###')
    print('Final Params: {}'.format(final_params))
    print('Final Cross Score: {} ({})'.format(final_mean, final_std))
    print('###')
